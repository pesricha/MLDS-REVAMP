...
\begin{frame}{EVD for PCA (Spectral Decomposition)}
    \begin{block}{EVD Special Case: Symmetric Matrices}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item $\mathbf{V} = [\mathbf{v}_1 \cdots \mathbf{v}_d]$ contains orthonormal eigenvectors
...
\begin{frame}{SVD for PCA}
    \begin{block}{Singular Value Decomposition}
        ...
        \begin{itemize}
            ...
            \item $\mathbf{U} \in \mathbb{R}^{n \times n}$, $\mathbf{V} \in \mathbb{R}^{d \times d}$ orthogonal
